...
for i in range(1, 14291):
    ...
    datas_2 = []
    url_1 = 'https://wbdt.ybj.qingdao.gov.cn/pss-gw/api/pss-pw/web/pw/getHilistBList'
...
# print(df_filtered)
df_filtered.to_excel('D:\pythonProject\pythonProject\青岛\青岛耗材.xlsx', index=False)
